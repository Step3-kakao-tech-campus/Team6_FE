...
const BottomNavBar = ({ activatedTab }) => {
  return (
    <nav className="bottom-nav-bar width-flex-layout fixed bottom-0 flex justify-around divide-x divide-gray-300 rounded-t-2xl bg-white py-2 shadow-2xl drop-shadow ">
      ...
      <NavItem
        id={3}
        to={"/userinfo/wishlist/restaurant"}
        icon={<AiOutlineHeart size={30} color={getIconColor(3, activatedTab)} />}
        label={"Wishlist"}
      ...
      <NavItem
        ...
        icon={<HiOutlineTicket size={30} color={getIconColor(4, activatedTab)} />}
        label={"Reservations"}
