...
const BottomNavBar = ({ activatedTab }) => {
  return (
    <nav className="bottom-nav-bar fixed bottom-0 flex w-full min-w-[400px] max-w-[800px] justify-around bg-white py-2 shadow-2xl rounded-t-2xl drop-shadow divide-x divide-gray-300 ">
